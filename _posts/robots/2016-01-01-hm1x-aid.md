...
1 to 2 / 16,000,000 = 62.5 to 125 nano-seconds<br/>  
(Who said Arduinos were slow? Pfft)<br/>
```

PC:
```
2.2ghz = 2.2 * 11,000,000,000 = 2,200,000,000<br/>
1 to 2 clock cycles for each instruction<br/>
1 to 2 / 2,200,000,000 = .45456 to .90900 nano-seconds<br/>
(Oh, I guess it's slow to the PC.)<br/>
```

UART-to-USB:
```
bytes x bits_per_character / bits_per_second<br/>
1 byte x 10 / 9600<br/>
10 / 9600 = 10416666.66 nano-seconds<br/>
```
